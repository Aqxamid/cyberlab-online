...
function buildPage(backendUrl, frontendUrl) {
  ...
  + '.flag-submit-box{background:#f0fdf4;border:1.5px solid #86efac;border-radius:10px;padding:14px 16px;margin:0 12px 12px;}\n'
  ...
  // Flag submit section (hidden until flag found)
  ...
  + '    <input id="flag-input" type="text" class="flex-1 border border-green-300 rounded-lg px-3 py-2 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-green-400" placeholder="FLAG{...}" spellcheck="false">\n'
  + '    <button id="submit-flag-btn" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-colors">Submit Flag</button>\n'
  + '  </div>\n'
  + '  <p class="text-xs text-green-600 mt-2">Your score at submission will be saved. Make sure you are ready!</p>\n'
  + '</div>\n'
  + '</div>\n'
